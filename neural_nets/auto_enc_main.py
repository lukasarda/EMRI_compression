...
def main():
    ...
    for epoch in range(epochs):
        ...
        model_path = '/pbs/home/l/lkarda/EMRI_compression/neural_nets/model_states/AE_CNN_{}_{}'.format(timestamp, epoch)
        torch.save(auto_enc.state_dict(), model_path)
        scheduler.step()
        torch.cuda.empty_cache()
    
    np.savez_compressed('/pbs/home/l/lkarda/EMRI_compression/neural_nets/loss/AE_CNN_'+folder+'_{}_{}_1'.format(epochs, batch_size), loss=trainer.losses)
